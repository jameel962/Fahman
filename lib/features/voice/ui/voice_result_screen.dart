            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  // Inquiry button - Navigate to inquiry screen with voice text
                  Expanded(
                    child: InkWell(
                      onTap: () {
                        if (text.trim().isEmpty) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(content: Text('auth_voice_empty'.tr())),
                          );
                          return;
                        }

                        // Navigate to inquiry screen with the voice text as initial message
